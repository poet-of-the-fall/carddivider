...
\newcommand{\coin}[1]{\includegraphics[height=1em]{banner/coin.png}\hspace{-0.7em}\raisebox{0.25em}{\tiny{#1}}\hspace{0.4em}}
...
\newcommand{\victorypoint}{\includegraphics[height=1em]{banner/victorypoint.png}\hspace{0.2em}}
