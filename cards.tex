...
\newcommand{\victorypoint}[1]{\includegraphics[height=1em]{banner/victorypointtoken.png}\hspace{-0.65em}\raisebox{0.25em}{\tiny{\textcolor{white}{#1}}}\hspace{0.3em}}
...
\begin{document}
	\begin{center}
		...
		\input{sets/de/intrigueEdition2.tex}
	    \input{sets/de/intrigue1RGG2014.tex}
