...
\begin{tikzpicture}
	...
	\cardcontent{Die aufgedeckten Karten legst du zunächst o en vor dir aus. Sollte dein Nachziehstapel beim Aufdecken zu Ende gehen, mischt du deinen Ablagestapel. Die bereits aufgedeckten Karten mischst du jedoch nicht mit ein, da diese Karten erst am Ende der Aktion auf den Ablagestapel gelegt werden. Hast du keine Karten mehr zum Aufdecken und noch immer nur eine Geldkarte, bekommst du nur diese eine.}
\end{tikzpicture}
\hspace{-0.6cm}
\begin{tikzpicture}
	\card
