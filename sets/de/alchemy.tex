...
\begin{tikzpicture}
	...
	\cardprice{3}
	\cardiconaddition{banner/potion.png}
	\cardtitle{\quad \scriptsize{Stein\thinspace der\thinspace Weisen}}
...
\begin{tikzpicture}
	...
	\cardprice{6}
	\cardiconaddition{banner/potion.png}
	\cardtitle{\quad \footnotesize{Besessenheit}}
	\cardcontent{\tiny{(Teil 1)
	\\
	\medskip
	\\
