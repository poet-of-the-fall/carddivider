...
\begin{tikzpicture}
	...
	\cardprice{5}
	\cardtitle{Ritter}
	\cardcontent{\miniscule{Dieser Kartenstapel ist ein gemischter Stapel. Jede Karte hat einen eigenen Namen und ist im Stapel genau 1x vorhanden. Mischt in der Spielvorbereitung alle RITTER, legt den RITTER-Stapel verdeckt in den Vorrat und deckt nur die oberste Karte auf. Immer die oberste Karte des RITTER-Stapels kann genommen werden.
