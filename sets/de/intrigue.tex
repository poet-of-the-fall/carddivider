...
\cardprice{4}
\cardtitle{Späher}
\cardcontent{Wenn der Nachziehstapel leer ist und du deinen Nachziehstapel mischt, werden die bereits aufgedeckten Karten nicht mit eingemischt. Du musst alle Punktekarten auf die Hand nehmen. Kombinierte Aktions-/Punktekarten sind auch Punktekarten. Fluchkarten sind keine Punktekarten. Du musst die Reihenfolge, in der du die Karten auf den Nachziehstapel legst nicht zeigen.}
\end{tikzpicture}
\hspace{-1cm}
\begin{tikzpicture}
\card
