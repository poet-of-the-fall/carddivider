...
\begin{tikzpicture}
	...
	\cardprice{6}
	\cardtitle{Festplatz}
	\cardcontent{Diese Karte ist eine Punktekarte und hat bis zum Ende des Spiels keine Funktion. Bei der Wertung des Spiels erhältst du pro 5 Karten mit unterschiedlichen Namen in deinem Kartensatz (Handkarten, Nachzieh- und Ablagestapel) 2 Siegpunkte. Ein Kartensatz mit bis zu 4 unterschiedlichen Kartennamen bringt dir zum Beispiel keine Punkte, Kartensätze mit 10 bis 14 unterschiedlichen Namen dagegen 4 Siegpunkte.}
\end{tikzpicture}
\hspace{-1cm}
\begin{tikzpicture}
	\card
