...
\begin{tikzpicture}
	...
	\cardcontent{
		\begin{singlespace}
		\tiny{Du erhältst einen zusätzlichen Kauf in deiner Kaufphase und +\coin{1} für jeden Geld-Marker, der auf dem Tableau Handelsroute liegt, wenn du die Karte auslegst. Dann musst du eine Karte aus deiner Hand entsorgen (wenn du noch eine Karte auf der Hand hast). 
		\\ \smallskip
