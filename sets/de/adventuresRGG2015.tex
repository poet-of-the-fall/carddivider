...
\begin{tikzpicture}
	...
	\smallskip
	\\
	Durch den Erwerb einer weiteren \emph{VERLORENEN KUNST} oder das Aufrufen eines \emph{LEHRERES} darfst du den Marker auf einen anderen Aktions-Vorratsstapel legen.\\}
\end{tikzpicture}
\hspace{-1cm}
\begin{tikzpicture}
	\card
