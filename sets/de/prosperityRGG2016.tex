...
\begin{tikzpicture}
	...
	\cardprice{4}
	\cardtitle{Bischof}
	\cardcontent{Du erhältst +\coin{1} und legst einen \victorypoint{1}-Marker auf dein Spieler-Tableau. Dann musst du eine Handkarte entsorgen, wenn du mindestens 1 Karte auf der Hand hast. Lege halb so viele \victorypoint{1}-Marker auf dein Spieler-Tableau, wie die entsorgte Karte gekostet hat. Ungerade Kosten werden abgerundet. Die \potion-Kosten (z.B. aus \emph{Alchemie}) spielen keine Rolle. So erhältst du je 2 \victorypoint{1}-Marker für ein entsorgtes \emph{ARBEITERDORF} (Kosten: \coin{4}), ebenso wie für ein \emph{GESINDEL} (Kosten: \coin{5}) oder einen \emph{GOLEM} (Kosten: \coin{4} und \potion). 
	\
	\medskip
	\\
...
\begin{tikzpicture}
	...
	\cardprice{4}
	\cardtitle{Denkmal}
	\cardcontent{Du erhältst +\coin{2} und legst einen \victorypoint{1}-Marker aus dem Vorrat auf dein Spieler-Tableau.}
\end{tikzpicture}
\hspace{-1cm}
\begin{tikzpicture}
	\card
...
\begin{tikzpicture}
	...
	\medskip
	\\
	Solange diese Karte im Spiel ist, legst du immer, wenn du eine Karte kaufst (nicht wenn du sie auf andere Weise nimmst), einen \victorypoint{1}-Marker auf dein Spieler-Tableau. Hast du zwei \emph{HALSABSCHNEIDER} im Spiel, legst du zwei \victorypoint{1}-Marker pro gekaufter Karte auf dein Tableau usw.\\}
\end{tikzpicture}
\hspace{-1cm}
\begin{tikzpicture}
	\card
