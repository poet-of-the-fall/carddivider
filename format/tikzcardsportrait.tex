...
\newcommand{\card}{
	...
	% Cardextension
	\node [anchor=south east,\cardcolor,minimum width=\stripwidth,minimum height=\stripheight] at ([xshift=-0.6*\stripwidth,yshift=\contentoffset]content.north east) {\tiny{\trajan \cardextension}};
	% Cardextensiontitle
	\node [anchor=south east,\cardcolor,minimum width=\stripwidth,minimum height=\stripheight] at ([xshift=-0.6*\stripwidth]content.north east) {\tiny{\trajan \cardextensiontitle}};
}
