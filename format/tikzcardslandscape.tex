...
\pgfmathsetlengthmacro{\iconwidth}{0.5cm}
...
\newcommand{\card}{
	...
	% Cardextension
	\node [anchor=south east,\cardcolor,minimum width=\stripwidth,minimum height=\stripheight] at ([xshift=-0.6*\stripwidth,yshift=1.25*\contentoffset]content.north east) {\trajan \cardextension};
	% Cardextensiontitle
	\node [anchor=south east,\cardcolor,minimum width=\stripwidth,minimum height=\stripheight] at ([xshift=-0.6*\stripwidth]content.north east) {\small{\trajan \cardextensiontitle}};
}
