...
\newcommand{\card}{
	...
	\node [anchor=south east,\cardcolor,minimum width=\stripwidth,minimum height=\stripheight] at ([xshift=-0.6*\stripwidth,yshift=1.25*\contentoffset]content.north east) {\textsc{\cardextension}};
	\node [anchor=south east,\cardcolor,minimum width=\stripwidth,minimum height=\stripheight] at ([xshift=-0.6*\stripwidth]content.north east) {\small{\textsc{\cardextensiontitle}}};
}
